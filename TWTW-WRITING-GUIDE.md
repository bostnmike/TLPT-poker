...
TL;DR, Felt Whispers (also formerly called Felt Said / What the Felt Said), and Quick Hits are permanently retired. Never generate `tldr`, `feltSaid`, `quickHitsLeft`, or `quickHitsRight` in a new story. Do not recreate the removed sections under different names, embed them in HTML, or move all of their content into another section.
...
- Main Story: usually three or four paragraphs. Establish the central hook, develop the winner/pivotal action, use the strongest supporting table storyline, and finish with a fresh ending. Each paragraph has a different purpose. Use the weekly poster first.
...
- Host Roast: always BostnMike/the Commissioner, never ProvidenceMike by mistake. One fresh, short closing joke, not a summary of the Main Story or a repeated punchline.
