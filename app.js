...
const COMMISSIONER_REPORTS = [
  ...
  "Li-Fo and NASA Al are starting to feel like two different tax brackets. One prints profit like a machine, the other posts numbers so clean they look pre-audited; everyone else is basically filing extensions.",
  "BostnMike has 26 hits and 5 bubbles, which is a beautiful way to say he’s both executioner and punchline. He knocks people out all night, then shows up near the money like he forgot why he came.",
  "Yann has one entry and somehow leads the league in both True Skill and Clutch. That’s not a sample size, that’s a ransom note from variance.",
  "Nitro currently has the worst luck and the lowest profit, which is the statistical version of getting mugged twice in the same parking lot. At this point the cards aren’t random—they’re personal.",
  "ProvidenceMike has 20 entries, 8 rebuys, and a negative profit, which means he’s giving the league both volume and charity. He’s basically Costco for other people’s bankrolls.",
  "Hiro has 32 entries and 22 hits, which sounds terrifying until you notice the profit line still looks like a clerical error. It’s a lot of action for a man still paying tuition.",
  "Chris O and Vish are proof that aggression and discipline are not legally married. One looks like he’s trying to break the table, the other looks like he’s trying to buy it back one rebuy at a time.",
  "Cougar has 15 entries, 10 hits, zero bubbles, and actual profit. That’s the kind of profile that doesn’t make noise—it just makes the rest of you look like hobbyists.",
  "A.I. Dave keeps putting up the kind of profile that says ‘solid player, unfortunate universe.’ He’s low-tilt, relatively clean, and still getting paid like poker uses unpaid internships.",
  "Red has enough aggression and hit rate to suggest a dangerous player, but the returns still hover around ‘nice try.’ He’s basically a fireworks show sponsored by break-even.",
  "Jeff T’s numbers continue to read like a man who offended a river deity. The effort is there, the attendance is there, the money is somewhere else.",
  "Wild Bill has the profile of a guy who should be easier to beat than he actually is. Then the profit shows up, shrugs, and reminds everybody that respectable play still needs receipts.",
  "The Architect continues to build thoughtful structures that collapse somewhere around the cash window. It’s not bad poker—it’s just zoning problems near the finish line.",
  "Big Tim owns the best ROI in the records and still somehow feels like a suspicious rumor. One entry, one cash, one giant number—he’s less a player and more a conspiracy theory with chips.",
  "Li-Fo has 12 cashes and the best luck number in the league, which is a brutal combo for everybody else. It means he’s not only good—he’s also being assisted by forces your local casino would classify as supernatural.",
  "NASA Al’s profile says he cashes often, hits hard, and almost never wastes motion. It’s like watching a very efficient home invasion.",
  "BostnMike and Hiro have both piled up hits, but only one of them turned the violence into real money. The other is basically doing demolition work for exposure.",
  "Nitro and Vish are conducting important research into whether repeated re-entry can eventually become a personality trait. Early results indicate yes, but not a profitable one.",
  "ProvidenceMike and Hiro are neck-and-neck in the category of ‘too much activity for this little joy.’ If volume alone paid, they’d both own summer homes by now.",
  "Chris O plays like the phrase ‘small edge’ personally insulted him. There’s a lot to admire there—especially if you’re one of the people cashing in around him.",
  "Cougar’s low-tilt, no-bubble, positive-profit line is the poker equivalent of somebody quietly doing all the homework while the rest of the class eats glue. Boring? Maybe. Effective? Annoyingly.",
  "Yann’s current record line is what happens when one night goes so well the spreadsheet starts lying to people. If he plays again and stays hot, the league may have to open an investigation.",
  "BostnMike has more hits than anyone and more bubbles than anyone, which is honestly a remarkable piece of dual citizenship. He’s elite at both causing exits and starring in them.",
  "Li-Fo cashes at a rate that makes other players question whether they’ve been playing the same game. At this point the man isn’t entering tournaments—he’s collecting rent.",
  "A.I. Dave and ProvidenceMike are a nice study in emotional economics. One keeps losses controlled and results modest, the other keeps participation robust and the donation line open.",
  "Red and Ahmed are both aggressive enough to make the room uncomfortable. The difference is Ahmed’s numbers say menace; Red’s numbers occasionally say ‘interesting side effect.’",
